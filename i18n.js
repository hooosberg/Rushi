...
(function () {
  ...
  const dict = {
    'zh-Hans': {
      ...
      'cta.title': '开始一段清净的修持',
      'cta.body': '如是 现已在 App Store 上架，免费下载。源经文已在 GitHub 公开。',
      'foot.app': '应用',
      'foot.legal': '法律',
      'foot.links': '链接',
      'foot.repo': 'GitHub',
      'foot.feedback': '反馈与建议', 'foot.contact': '联系',
    ...
    'zh-Hant': {
      ...
      'hero.cta.store': 'App Store · 現已上架', 'hero.cta.github': '在 GitHub 上查看源經文',
      ...
      'cta.title': '開始一段清淨的修持', 'cta.body': '如是 現已在 App Store 上架，免費下載。源經文已在 GitHub 公開。',
    ...
    'en': {
      ...
      'hero.cta.store': 'Download on the App Store', 'hero.cta.github': 'See source scriptures on GitHub',
      ...
      'cta.body': 'Rushi is now available on the App Store, free to download. The source scriptures are public on GitHub.',
    ...
    'ja': {
      ...
      'hero.subtitle': '如是我聞 · As I have heard',
      'hero.cta.store': 'App Store · 配信中', 'hero.cta.github': 'GitHub で原典を見る',
      ...
      'cta.body': '如是 は App Store で公開中です。無料でダウンロードできます。原典は GitHub で公開されています。',
    ...
    'ko': {
      ...
      'hero.subtitle': '如是我聞 · As I have heard',
      'hero.cta.store': 'App Store · 지금 다운로드', 'hero.cta.github': 'GitHub 에서 원전 보기',
      ...
      'cta.body': '如是 는 지금 App Store 에서 무료로 다운로드할 수 있습니다. 원전은 이미 GitHub 에 공개되어 있습니다.',
      'foot.app': '앱', 'foot.legal': '법적', 'foot.links': '링크', 'foot.repo': 'GitHub', 'foot.feedback': '피드백', 'foot.contact': '연락처',
    ...
    'vi': {
      ...
      'hero.cta.store': 'App Store · Tải ngay', 'hero.cta.github': 'Xem kinh nguồn trên GitHub',
      ...
      'cta.body': 'Rushi đã có trên App Store, tải miễn phí. Kinh nguồn đã công khai trên GitHub.',
      'foot.app': 'Ứng dụng', 'foot.legal': 'Pháp lý', 'foot.links': 'Liên kết', 'foot.repo': 'GitHub', 'foot.feedback': 'Phản hồi', 'foot.contact': 'Liên hệ',
    ...
    'de': {
      ...
      'hero.cta.store': 'App Store · jetzt laden', 'hero.cta.github': 'Quelltexte auf GitHub',
      ...
      'cta.body': 'Rushi ist jetzt im App Store verfügbar, kostenlos. Die Quelltexte sind auf GitHub frei verfügbar.',
      'foot.app': 'App', 'foot.legal': 'Rechtliches', 'foot.links': 'Links', 'foot.repo': 'GitHub', 'foot.feedback': 'Feedback', 'foot.contact': 'Kontakt',
    ...
    'fr': {
      ...
      'hero.cta.store': 'App Store · disponible', 'hero.cta.github': 'Voir les sources sur GitHub',
      ...
      ‘cta.body’: "Rushi est disponible sur l’App Store, gratuit. Les textes sources sont publics sur GitHub.",
      'foot.app': 'App', 'foot.legal': 'Légal', 'foot.links': 'Liens', 'foot.repo': 'GitHub', 'foot.feedback': 'Retours', 'foot.contact': 'Contact',
    ...
    'th': {
      ...
      'hero.cta.store': 'App Store · ดาวน์โหลดเลย', 'hero.cta.github': 'ดูพระสูตรต้นฉบับใน GitHub',
      ...
      'cta.body': 'Rushi พร้อมให้ดาวน์โหลดบน App Store แล้ว ฟรี พระสูตรต้นฉบับเปิดเผยบน GitHub',
      'foot.app': 'แอป', 'foot.legal': 'กฎหมาย', 'foot.links': 'ลิงก์', 'foot.repo': 'GitHub', 'foot.feedback': 'ข้อเสนอแนะ', 'foot.contact': 'ติดต่อ',
