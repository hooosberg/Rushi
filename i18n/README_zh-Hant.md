<p align="center">
  <img src="../icons/app-icon-rounded-256.png" alt="如是" width="128" height="128">
</p>
...
<p align="center">
  <a href="../LICENSE"><img src="https://img.shields.io/badge/scriptures-CC0%201.0-1e88e5.svg" alt="經文 CC0"></a>
  ...
  <br>
  <img src="https://img.shields.io/badge/sutras-13%20editions-43a047.svg" alt="13 個經文版本">
  <img src="https://img.shields.io/badge/UI%20languages-17-43a047.svg" alt="17 種介面語言">
  <img src="https://img.shields.io/badge/privacy-Data%20Not%20Collected-2e7d32.svg" alt="不收集任何資料">
</p>

<p align="center">
  <a href="https://hooosberg.github.io/Rushi/">
    <img src="../posters/sheet-zh-Hant.webp" alt="如是 — 五屏預覽" width="720">
  </a>
</p>
...
- **真正本地** —— 無帳號、無雲端上傳、無分析 SDK。可選 iCloud 同步使用你自己的私人 CloudKit 資料庫，由 Apple 端對端加密。
...
| 資料儲存 | app sandbox + 你的私人 iCloud（可選） |
...
iOS app 使用 Swift 5 / SwiftUI 在 iOS 17 上建構：本地儲存用 SwiftData；經文排版用 CoreText（自行實作繞過 iOS 17 `UIFont(name:)` bug 的中文襯線 fallback，透過 `CTFontCreateWithName`）；掛飾擺動手感用 CoreMotion；可選私人 iCloud 同步用 CloudKit。Swift 原始碼暫未開源；本倉庫僅包含落地頁和經文。
